...
//Main Menu
//2D Paint description (Shift-JIS) 0x18A17C
//2D Movie description (Shift-JIS) 0x18A1B4
//3D World description (Shift-JIS) 0x18A1F4
//Gallery  description (Shift-JIS) 0x18A23C

//Save or work will disappear (Shift-JIS) 0x18A2E8
...
//Save/Load (1) 0x2AAAD0
//Save/Load (2) 0x2E00C0
