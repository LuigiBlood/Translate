...
putTextnoSeek("Container is full.") //RAM 0x802FD010
...
saveload4_enterdisk:
putTextnoSeek("Cannot save anymore on this disk.") //RAM 0x802FD0C0
...
saveload4_reread:
putText4noSeek("Reread because the disk", $00FF, "has been replaced.") //RAM 0x802FD1E0 Unused?
