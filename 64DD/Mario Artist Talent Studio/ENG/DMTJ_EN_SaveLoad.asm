...
textEntryH0("Exit")			//�ł�
save1_2:
textEntryH0("Save")			//�����Ђ�Z�[�u
save1_3:
textEntryH0("Load")			//�����Ђ񃍁[�h
save1_4:
textEntryH0("Rename")			//�Ȃ܂��ւ񂱂�
save1_5:
textEntryH0("Delete")			//�����Ђ�̂�������
save1_6:
textEntryH0("Move/Copy")			//�����Ђ�̂��ǂ��E�R�s�[
save1_7:
textEntryH0("Create Container")		//������̂�������
save1_8:
textEntryH0("Change Disk")		//�f�B�X�N�̂��ꂩ��

save1_9:
textEntryH0("Hiragana")			//�Ђ炪��
save1_10:
textEntryH0("Katakana")			//�J�^�J�i
save1_11:
textEntryH0("AaBbCc")			//��������
save1_12:
textEntryH0("Kanji/Symbols")		//����/������
save1_13:
textEntryH0("All")			//�Ђ炪��/�J�^�J�i/��������
save1_14:
textEntryH0("Space")			//�����͂�
save1_15:
textEntryH0("Left")			//���ǂ�
...
seekFile(0x34B30)
save3_1:
textEntryH0("Please do not eject the disk.")	//�f�B�X�N�� �ʂ��Ȃ��ł�������
save3_2:
textEntryH0("Preparing to save...")		//�Z�[�u�̂����т����Ă��܂�
save3_3:
textEntryH0("Some files cannot be used here.")	//�����ł������Ȃ��t�@�C�����ӂ��܂�܂���
...
seekFile(0x35B20)
save5_1:
textEntryH0("Please eject the disk.")				//RAM 802FDE40 - �f�B�X�N�� �Ƃ肾���Ă�������
save5_2:
textEntryH0("Please insert a disk.")				//RAM 802FDE60 - �f�B�X�N�� ����Ă�������
save5_3:
textEntryH0("Please insert the original disk.")			//RAM 802FDE7C - ���ǂ��f�B�X�N������Ă�������
save5_4:
textEntryH0("The wrong disk has been inserted.")			//RAM 802FDE9C - �܂��������f�B�X�N���͂����Ă��܂�
save5_5:
textEntryH0("Loading content from a different disk.")		//RAM 802FDEC0 - �ׂ̃f�B�X�N�Ƃ��ꂩ���܂�
save5_6:
textEntryH0("Change to the original Talent Studio disk.")		//RAM 802FDEE0 - ���Ƃ̃f�B�X�N�� ���ꂩ���܂�
save5_7:
textEntryH0("Loading content from a different disk.")		//RAM 802FDF00 - �ׂ̃f�B�X�N�� �����Ђ����݂��݂܂�
save5_8:
textEntryH0("Change to the original Talent Studio disk.")		//RAM 802FDF2C - ���Ƃ̃f�B�X�N����݂��݂܂�
save5_9:
