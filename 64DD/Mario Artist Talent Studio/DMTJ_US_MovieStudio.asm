...
dh (prod1_shoot00)
seek(0x1066F84)
sb t5,prod1_shoot00 + 12/2(at)
seek(0x1066F8C)
sb 0,prod1_shoot00 + 14/2(at)
seek(0x1066FF8)
sb t8,prod1_shoot00 + 12/2(at)
seek(0x106702C)
sb t1,prod1_shoot00 + 14/2(at)
seek(0x1069F72)
dh (prod1_playstop)
seek(0x106A122)
...
seek(0x11CE084)	//ASM
sb t1,moviegraffitiedit_colorpattern1 + 28/2(at)
